...
@Component({
	...
	entryComponents: [BossyCalendar, BossyForm, BossyInput, BossyDropdown, BossyDropdownMenuItem], // Reference to the components must be here in order to dynamically create them
